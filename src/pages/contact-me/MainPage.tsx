    ...
    <section className="h-full w-full bg-[#070727] overflow-hidden flex flex-col justify-center items-center gap-5">
      <div className="">
        <div className="flex gap-16 py-8">
          <div className="w-72 h-72 bg-white text-black font-poppins rounded-xl flex flex-col gap-2 items-center px-6 py-5">
            ...
            <div className="flex gap-1">
              ...
              >
                <img src={githubIcon} className="size-6" />
              </a>
              ...
              <a
                ...
                rel="noopener noreferrer"
              >
                <img src={linkedinIcon} className="size-6" />
              </a>
              <a
              ...
              <a
                ...
                rel="noopener noreferrer"
              >
                <img src={emailIcon} className="size-6" />
              </a>
            </div>
          </div>
        </div>
